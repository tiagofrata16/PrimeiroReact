    ...
    <section className = {styles.containerTopicos}>
      <div className = {styles.topico}>
        ...
        <div>
            ...
            <p className = {styles.topicoParagrafo}>What happens when old PCs <br/>
      ...
      <div className = {styles.topico}>
        ...
        <div>
            ...
            <p className = {styles.topicoParagrafo}>Our best picks for various <br/>
            needs and budgets.
            </p>
        </div>
      </div>
      <div className = {styles.topico}>
        ...
        <div>
            ...
            <p className = {styles.topicoParagrafo}>How the pandemic has sparked <br/>
            fresh opportunities.
            </p>
        </div>
      </div>
