...
function BarraLateral() {
    return (
        <div className = {styles.barraLateral}>
            <h1>New</h1>
            <h2 className = {styles.titulo1}>Hydrogen VS Electric Cars</h2>
            <p>Will hydrogen-fueled cars ever catch up<br/>
             to EVs?</p>
            <h2 className = {styles.titulo2}>The Downsides of Al Artistry</h2>
            <p>What are the possible adverse effects of<br/>
             on-demand AI image generation?</p>
            <h2 className = {styles.titulo3}>Is VC Funding Drying Up?</h2>
